...
const BL_CASES = BL_BASE + '?where=1%3D1&outFields=OBJECTID,Fallzahl,Death,faelle_100000_EW,LAN_ew_GEN,OBJECTID_1,Aktualisierung&returnGeometry=false&f=json'
...
export function fetchCountyCases () {
  return get(LK_CASES)
}
...
export function fetchStateCases () {
  return get(BL_CASES)
}
